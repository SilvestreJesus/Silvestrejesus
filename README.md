...
* **Sistema de Recolección de Residuos**
    Software de gestión logística para rutas de recolección de basura. Desarrollado en el entorno de **NetBeans**, integrando una base de datos relacional en **MySQL** y gestionando dependencias del ecosistema con **npm**.
<!--
